            ...
            '<div class="modal fade" id="'+r+'">'+
                '<div class="modal-dialog">'+
                    ...
                    '<div class="modal-footer">'+
                        '<button type="button" class="btn btn-'+arguments[2]+'" data-bs-dismiss="modal">Close</button>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                '</div>'
        ...
        $("body").append(
            '<div class="modal fade" id="'+r+'">'+
                '<div class="modal-dialog">'+
                    ...
                    '</div>'+
                    '<div class="modal-footer">'+
                        '<button type="button" class="btn btn-'+arguments[2]+'" data-bs-dismiss="modal">'+arguments[3]+'</button>'+
                    '</div>'+
                    '</div>'+
                    '</div>'+
                '</div>'
